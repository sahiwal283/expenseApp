...
// Version: 1.10.1 - PATCH: Fix EasyOCR HOME environment
...
const CACHE_NAME = 'expenseapp-v1.10.1';  // BUMPED VERSION for EasyOCR HOME fix
const STATIC_CACHE = 'expenseapp-static-v1.10.1';
const urlsToCache = [
  '/',
  '/index.html',
  '/favicon.svg',
...
self.addEventListener('install', (event) => {
  console.log('[ServiceWorker] Installing v1.10.1...');
  event.waitUntil(
...
self.addEventListener('activate', (event) => {
  console.log('[ServiceWorker] Activating v1.10.1...');
  ...
  event.waitUntil(
    caches.keys().then((cacheNames) => {
      ...
      console.log('[ServiceWorker] v1.10.1 activated and ready!');
