...
// Version: 1.23.2 - Feature: Separate Google Vision & All Receipts metrics
...
const CACHE_NAME = 'expenseapp-v1.23.2';  // BUMPED VERSION for separate metrics
const STATIC_CACHE = 'expenseapp-static-v1.23.2';
const urlsToCache = [
  '/',
  '/index.html',
  '/favicon.svg',
