/**
 * ExpenseModal Components
 * 
 * Centralized exports for all modal sub-components
 * Extracted from monolithic ExpenseSubmission.tsx
 */

export { ExpenseModalHeader } from './ExpenseModalHeader';
export { ExpenseModalFooter } from './ExpenseModalFooter';
